          ...
          <div class="col-md-12">
            <card>
              <form @submit.prevent="createHebergement">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 pr-md-1 text-left">
                   ...
                   <!--  <base-input
                    ...
                    ></base-input> -->
                    <p
                      v-if="validationErrors.nbr_chambre_dispo && hebergement.type == 'par chambre'"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                ...
                <hr />
                <div class="row" v-if="hebergement.type == 'par chambre'">
                  <div class="col-md-12">
                    <div
                    ...
                    >
                      <div class="row" style="padding: 10px">
                        ...
                        <div class="form-group col-md-3">
                          <label style="line-height: 35px">
                            <b> Nombres des lits du Chambre {{ index + 1 }}</b>
                          </label>
                          <input
                            aria-label="label"
