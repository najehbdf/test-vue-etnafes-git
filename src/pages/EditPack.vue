  ...
  <div class="content">
    ...
    >
      ...
      <fieldset class="scheduler-border">
        <legend class="scheduler-border">Ajouter</legend>
        <div class="control-group">
          <card>
            ...
            <div class="row">
              <form @submit.prevent="addProgrammePack">
                <div class="col-md-12">
                  <div
              ...
              >
                <div
                  ...
                  style="
                    ...
                    border-radius: 0.2857rem;
                  "
                  v-for="villepack in pack.ville_pack"
                  :key="villepack.id"
                >
                  <div class="row">
                    <div class="col-md-11">
    ...
    <card style="border: solid 1px; padding: 15px">
      ...
      <form v-on:submit.prevent="updatePack(pack.id, pack)" class="mb-3">
        <div class="row">
          ...
          <div class="col-md-1 pl-md-1 text-left">
            ...
            <p
              ...
              style="padding-bottom: 5px; color: red"
            >
              <span class="alert-link">** {{ validationErrors.time[0] }}</span>
            </p>
          </div>
        ...
        <div class="row">
          <div class="col-md-3 pr-md-1 text-left">
            <label>Prix pour enfant plus que 4 ans</label>
            <input
              aria-label="label"
              oninput="this.value = Math.round(this.value);"
              style="width: 100% !important"
    ...
    <card style="border: solid 1px; padding: 15px">
      <div class="row" style="padding: 10px">
        <div class="col-md-10">
          ...
          <div v-for="(zone, index) in zone_pack" v-bind:key="index">
    ...
    <card style="border: solid 1px; padding: 15px">
      <div class="row" style="padding: 10px">
        <div class="col-md-10">
          ...
          <div v-for="(programme, index) in pack.programmes" v-bind:key="index">
            <p>
              <b>{{ programme.titre }}</b> &nbsp;
              <i
                class="fa fa-edit text-info mr-3"
    ...
    <div v-for="imagepack in imagepacks" :key="imagepack.id">
      <b-card>
        <div class="col-md-4">
          <img loading="lazy"
            alt="pack"
  ...
  methods: {
    ...
    addProgrammePack(e) {
      ...
      for (var i = 0; i < this.programmes.length; i++) {
        let progTitre = this.programmes[i].titre;
        let progDescription = this.programmes[i].description;
        formData.append("programmes[" + i + "][titre]", progTitre);
        formData.append("programmes[" + i + "][description]", progDescription);
      }
      axios
        .post(
          `${apiDomain}/api/create/programme/pack/${this.$route.params.id}`,
          formData
        )
        .then(function (response) {
          if (response.status == 200) {
            if (confirm("programme Ajoutée")) {
              window.location.reload();
            }
          }
        })
    ...
    fetchProgramme(id) {
      fetch(`${apiDomain}/api/programme/${id}?token=${this.$store.state.token}`)
        .then((res) => res.json())
        .then((res) => {
