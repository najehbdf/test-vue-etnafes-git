  ...
  <div>
    ...
    <div
      ...
      style="
        ...
        background-image: url('../images/guide-etnafes.jpg');
            ...
            <div class="panel-body">
              <form accept-charset="UTF-8" role="form" @submit.prevent="performLogin">
                <fieldset>
                  ...
                  <div class="checkbox">
                    <router-link to="/guide_reset_mdp">
                      <p style="color: #1c4b94; font-weight: bold">Mot de passe oublié ?</p>
                    </router-link>
                  </div>
                  ...
                  <div>
                    ...
                    <a href="/register/guide">S'inscrire</a>
                  </div>
                </fieldset>
              </form>
            </div>
