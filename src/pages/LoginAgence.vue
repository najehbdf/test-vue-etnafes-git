  ...
  <div>
    ...
    <div
      ...
      style="
        ...
        background-image: url('../images/agence-de-voyage-etnafes.jpg');
        ...
        <div class="col-md-4 offset-md-7">
          <div class="panel panel-default style_login_voyageur">
            <div class="panel-heading">
              <h3 class="panel-title" style="color: #000">Proprietaire Prestataire de Services</h3>
            </div>
              ...
              <form accept-charset="UTF-8" role="form" @submit.prevent="performLogin">
                <fieldset>
                  ...
                  >
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-4" style="margin-left: 73px">
                        <span class="btn btn_login_google" data-channel="google">
                  ...
                  <div>
                    ...
                    <a href="/register/agence">S'inscrire</a>
                  </div>
                </fieldset>
              </form>
            </div>
    ...
    performLogin() {
      ...
      this.$store
        ...
        .then(res => {
          ...
          this.$router.push("/nouveaupack/agence");
        })
        .catch(error => {
          ...
          if (error.response && error.response.status == 403) {
            ...
            this.$router.push("/adagence_verification");
          }
        });
    }
  }
