      ...
      <div class="col-md-12">
        <card>
          <template slot="header">
            <h5 class="title" style="padding-top:15px">Ajouter une zone touristique</h5>
          </template>
          <form @submit.prevent="createZone">
            <div class="row">
              <div class="col-md-5 pr-md-1 text-left">
                <base-input label="Nom" placeholder="Nom" v-model="zone.nom"></base-input>
          ...
          padding: 0.375rem 0.75rem;width: 100%;"
            ...
            <div class="row">
              <div class="col-md-12">
                <gmap-map :center="zone.center" :zoom="6" style="width:100%;  height: 270px;">
                  <gmap-marker
                    :key="index"
                    v-for="(m, index) in markers"
                    :position="m.position"
                    @click="zone.center=m.position"
                  ></gmap-marker>
                </gmap-map>
              </div>
            </div>
              ...
              <div class="col-sm-12 col-xs-3">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select
                        class="form-control"
                        id="SelectRegion"
                        @change="updateVilleid;fetchSousVille(zone.ville_id)"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Ville</label>
                      <select class="form-control" v-model="zone.sous_ville_id">
            ...
            <div class="row">
              <div class="col-md-12 text-left">
                <h5 class="title">Photos de la zone touristique</h5>
                <form>
                  <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    createZone(e) {
      ...
      formData.append("nom", this.zone.nom);
      formData.append("description", this.zone.description);
      formData.append("url_video", this.zone.url_video);
      formData.append("ville_id", this.zone.ville_id);
      formData.append("sville_id", this.zone.sous_ville_id);
      ...
      axios
        .post(`${apiDomain}/api/zone/images`, formData, {
          headers: {
        ...
        .then(res => {
          if (res.status == 200) {
            this.$noty.success("votre zone touristique a été créé.");
