          ...
          <form @submit.prevent="createProduit">
            <div class="row">
              <div class="col-md-4 pr-md-1 text-left">
                ...
                ></base-input> -->
<label>Nom</label> 
                <input type="text" style="height: calc(2.75rem + -5px) !important;"
                  label="Nom"
                  placeholder="Nom"
                  v-model="zone.titre"
                />
              ...
              <div class="col-md-12 text-left">
                <base-input>
                  ...
                  <!--  <b-form-textarea
                    ...
                    maxlength="450"
                  ></b-form-textarea> -->
                  <!-- <Vueditor v-model="content"></Vueditor> -->
                  <!--  <editor v-model="zone.description"
       api-key="npx8xrrpxsi82mhofjk0n1qyq69dhdwjb5scdb8n7ukys5ul"
       :init="{
         height: 500,
         menubar: false,
         plugins: [
...
export default {
  ...
  computed:{
    ...
    getTinyContent(){
     ...
     var myContent = getTinymce.get('d1').getContent({ format: "text" });


    
  // var myContent = tinymce.get("d1").getContent();
return myContent;
    },
  ...
  methods: {
    ...
    createProduit(e) {
     ...
     // formData.append("description", this.zone.description);
      formData.append("description", this.getTinyContent);
