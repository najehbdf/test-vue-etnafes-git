<template>
  <div class="content">
    <b-tabs card>
              ...
              <card style="border: solid 1px #7a7979">
                <div class="row">
                  ...
                  <div class="col-md-4 pl-md-1 text-left">
                    ...
                    />
                    <p
                      v-if="validationErrors.date_fin"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.date_fin[0] }}</span
                      >
                    </p>
                  </div>
                </div>
      ...
      <b-tab title="Mes Packs" v-show="adagence.adagence == 1">
        <template #title>
          Mes Packs
          <span
      ...
      <b-tab title="Mes Agences" active v-show="adagence.adagence == 1">
        <template #title>
          Mes Agences
          <span
            class="badge badge-pill badge-danger"
    ...
    createPack(e) {
      ...
      axios
        ...
        .then((res) => {
          if (res.status == 200) {
            this.$fire({
              text: "votre pack a été ajouté avec succès,en ttente de validation",
              type: "success",
              timer: 90000,
            }).then((r) => {
