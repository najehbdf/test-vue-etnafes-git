          ...
          <div class="panel panel-default style_login_voyageur">
            <div class="panel-heading">
              <h3
                class="panel-title"
                style="color: #000"
              >PROPRIETAIRE RESTAURANT - Mot de passe oublié</h3>
            </div>
            <form>
...
export default {
  ...
  methods: {
    ...
    submitPassword() {
      ...
      axios
        .post(`${apiDomain}/api/recoverNewPassword-proprestau`, {
        ...
        .then(res => {
          if (res.status == 200) {
            ...
            // this.clear();
            this.$router.push({ path: "/login/proprietaire_restaurant" });
          }
        })
        .catch(error => {
          this.isLoadingSendchangePass = false;
    ...
    sendToken() {
      ...
      if (!this.erreurEmail) {
        ...
        axios
          .post(`${apiDomain}/api/send-token-proprestau`, data)
          .then(() => {
    ...
    validateToken() {
      ...
      if (!this.errorToken) {
        ...
        axios
          .post(`${apiDomain}/api/validate-token-proprestau`, data)
          .then(response => {
