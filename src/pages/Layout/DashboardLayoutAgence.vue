<template>
  <div class="wrapper">
    ...
    <side-bar :background-color="backgroundColor">
      ...
      <sidebar-link to="/dashboard_agence">
      ...
      <sidebar-link to="/packs/agence">
        <i class="tim-icons icon-notes"></i>
        <template v-if="!isRTL">
          <p style="color:#fff">Mes packs</p>
        </template>
        <template v-else>
          <p>طباعة</p>
        </template>
      ...
      <sidebar-link to="/agence-réservations">
      ...
      <sidebar-link to="/agences">
        <i class="tim-icons icon-bulb-63"></i>
        <template v-if="!isRTL">
          <p style="color:#fff">Mes agences</p>
        </template>
        <template v-else>
          <p>طباعة</p>
        </template>
