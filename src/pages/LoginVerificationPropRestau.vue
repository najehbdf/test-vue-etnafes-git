    ...
    >
      <div class="row">
        <div class="col-md-4 offset-md-7" v-if="showLogin==true">
          ...
          >
            <div class="panel-heading">
              <h3 class="panel-title" style="color:#000">Proprietaire</h3>
            </div>
        ...
        <div class="col-md-4 offset-md-7" v-if="showLogin==false">
          ...
          >
            <div class="panel-heading">
              <h3 class="panel-title" style="color:#000">Vérification compte Proprietaire</h3>
            </div>
            <div class="panel-body">
              <form>
                <div class="form-group">
  ...
  methods: {
    ...
    verifEmail() {
      ...
      if (!this.errorTokenVerifEmail) {
        ...
        axios
          .post(`${apiDomain}/api/validate-email-proprestau`, data)
          .then(response => {
    ...
    performLogin() {
      this.isLoading = true;
      this.$store
        .dispatch("performLoginPropRestauAction", {
          email: this.email,
          password: this.password
        })
        .then(res => {
          this.isLoading = false;
          this.$router.push("/dashboard_proprietaire_restau");
        })
