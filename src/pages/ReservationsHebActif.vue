<template>
  <div class="content">
    <b-tabs card>
      <b-tab title="Ajouter un hébergement">
        <div class="row">
          <div class="col-md-12">
            <card>
                ...
                <div class="row">
                  <div class="col-md-4 pr-md-1 text-left">
                    <label class="control-label">
                      Nom
                      <span v-if="validationErrors.nom" style="padding-bottom: 5px; color: red">
                        <span class="alert-link">** {{ validationErrors.nom[0] }}</span>
                      </span>
                    </label>
                    <base-input placeholder="Nom" name="nom" v-model="hebergement.nom"></base-input>
                  </div>
                  ...
                  <div class="col-sm-12 col-xs-3">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Ville</label>
                          <select class="form-control" required v-model="hebergement.sous_ville_id">
      ...
      <b-tab title="Mes Hébergements" v-show="proprietaire.proprietaire==1">
        <template #title>
          Mes Hébergements
          <span
      ...
      <b-tab title="Mes Hébergements" disabled v-if="proprietaire.proprietaire==0">
        <template #title>
          Mes Hébergements
          <span
            class="badge badge-pill badge-danger"
      ...
      <b-tab title="Mes réservations" active v-show="proprietaire.proprietaire==1">
        <template #title>
          Mes réservations
          <span
            class="badge badge-pill badge-danger"
      ...
      <b-tab title="Mes réservations" disabled v-if="proprietaire.proprietaire==0">
        <template #title>
          Mes réservations
          <span
            class="badge badge-pill badge-danger"
      ...
      <b-tab title="Statistiques" v-show="proprietaire.proprietaire==1">
        <DashboardProprietaire></DashboardProprietaire>
      </b-tab>

      <b-tab title="Statistiques" disabled v-if="proprietaire.proprietaire==0">
        <DashboardProprietaire></DashboardProprietaire>
      </b-tab>
      ...
      axios
        ...
        .then(res => {
          if (res.status == 200) {
            this.$fire({
              text:
                "votre hebergement a été ajouté avec succès,en attente de validation",
              type: "success",
              timer: 90000
            }).then(r => {
